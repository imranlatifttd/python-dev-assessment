...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_discovered_queries_opportunity_score'), 'discovered_queries', ['opportunity_score'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_discovered_queries_opportunity_score'), table_name='discovered_queries')
